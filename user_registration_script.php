<?php
    ...
    if($rows_fetched>0){
        ...
        $uTime=date("h:i:sa");
        $uDate=date("Y-m-d");
        $user_registration_query="INSERT INTO users(uName,gender,email,password,contact,city,address,uDate,uTime) VALUES ('$name','$gender','$email','$password','$contact','$city','$address','$uDate','$uTime')";
